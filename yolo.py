...
all_classes = [c.split() for c in class_name ]
...
pimage = cv2.resize(image,dsize = (416,416)) #YOLO algosunun istediği boyut
...
for box, score,cl in zip(boxes,classes,scores):
    x,y,w,h = box
